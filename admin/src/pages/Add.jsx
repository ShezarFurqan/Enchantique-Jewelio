    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
      ...
      <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
        ...
        <div>
          ...
          <input onChange={(e) => setQuantity(e.target.value)} className='w-full px-3 py-2 sm:w-[120px]' type="Number" placeholder='25' />
        </div>
      ...
      <div>
        ...
        <div>
          <p className='mb-2'>Fake Price</p>
          <input onChange={(e) => setRealPrice(e.target.value)} className='w-full px-3 py-2 sm:w-[120px]' type="Number" placeholder='25' />
        </div>
      </div>
      ...
      <div>
        ...
        <p className='my-3'>Sizes Chart</p>
        <div className="flex gap-3">
      ...
      <div className='flex gap-2 mt-2 '>
        ...
        <input onChange={() => setNewCollection(prev => !prev)} checked={newCollection} type="checkbox" id='New Collection' />
        <label className='cursor-pointer' htmlFor="New Collection">Add to New Collection</label>
      </div>
